...
<html>
    ...
    <body background="bg.jpg" style="background-size:100% 100%;background-attachment:fixed;background-repeat:no-repeat;">
        <br><br>
        <div class="container" style="max-width: 400px; text-align: center; margin-top: 10px;">
            <form action="checkLogin.php" method="POST">
                <h2 style="color:white;">Login to the Hospital Database</h2>
                <?php
